...
class PollsControllerTest < ActionController::TestCase
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post :create, poll: { name: @poll.name, poll_number: @poll.poll_number, question_id: @poll.question_id }
    end
  ...
  test "should update poll" do
    patch :update, id: @poll, poll: { name: @poll.name, poll_number: @poll.poll_number, question_id: @poll.question_id }
    assert_redirected_to poll_path(assigns(:poll))
  end
